...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/28 15:57:54 by rghazary          #+#    #+#             */
/*   Updated: 2025/08/28 15:57:56 by rghazary         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap & ClapTrap::operator = (const ClapTrap & obj)
{
	...
	std::cout << "\033[34m" << "ClapTrap " << this->name <<" Copy assignment operator called" << "\033[0m" << std::endl;
	return *this;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (this->hit_points == 0)
	{
		std::cout << "ClapTrap " << this->name << " has " << this->hit_points << " hit points left to be repaired!";
	}
	else if (this->energy_points == 0)
	{
		std::cout << "ClapTrap " << this->name << " has " << this->energy_points << " energy points left to be repaired!";
	}
	else
	{
